...
public:
    ...
    void clockIn() {
        ...
        // Record the time when clocking in
    ...
    void clockOut() {
        ...
        // Record the time when clocking out
        clockOutTime = chrono::system_clock::now();

        // Save clock-out time to file
        saveClockTime("clock_times.txt", false);

        // Calculate the elapsed time since clocking in
    ...
    void viewSchedule() {
        ...
        // Only allow employees to view their own schedule
...
public:
    ...
    // Function to find the index of an employee in the vector
...
// Friend function definition for Employee
void logout(Employee& emp) {
    cout << "Logging out..." << endl;
    emp.isLoggedIn = false;
}

// Friend function definition for Admin
void logout(Admin& admin) {
    cout << "Logging out..." << endl;
}

// Additional functionality for Admin class
